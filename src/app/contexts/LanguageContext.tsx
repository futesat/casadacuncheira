...
Calçado de montanha adequado, água suficiente (não há fontes no topo) e evitar a subida com nevoeiro denso ou chuva sobre a rocha escorregadia.`
  ...
  'location.lira.desc': { es: 'Pueblo marinero tradicional, puerto pesquero artesanal de Portocubelo y calas vírgenes de naturaleza salvaje', gl: 'Pobo mariñeiro tradicional, porto pesqueiro artesanal de Portocubelo e calas virxes de natureza salvaxe', en: 'Traditional fishing village, Portocubelo artisanal harbor, and pristine wild coves', fr: 'Village de pêcheurs traditionnel, port artisanal de Portocubelo et criques sauvages et préservées', de: 'Traditionelles Fischerdorf, malerischer Hafen Portocubelo und unberührte wilde Badebuchten', it: 'Borgo marinaro tradizionale, porto peschereccio di Portocubelo e calette selvagge e incontaminate', pt: 'Vila piscatória tradicional, porto artesanal de Portocubelo e enseadas virgens de natureza selvagem' },
